...
class _MyMeetingsState extends State<MyMeetings> {
  ...
  String thisWeek = "0:00h";
  String lastWeek = "0:00h";
  String thisMonth = "0:00h";
  String lastMonth = "0:00h";
  ...
  Future _getThisWeek() async {
    SharedPreferences.getInstance().then((value) {
      ...
      http.get(
        "https://mobibookingwebapi.azurewebsites.net/api/Meetings/this_week",
        headers: {
  ...
  Future _getLastWeek() async {
    SharedPreferences.getInstance().then((value) {
      ...
      http.get(
        "https://mobibookingwebapi.azurewebsites.net/api/Meetings/last_week",
        headers: {
          "Content-Type": "application/json",
          "Authorization": "bearer " + token
        },
  ...
  Future _getThisMonth() async {
    SharedPreferences.getInstance().then((value) {
      ...
      http.get(
        "https://mobibookingwebapi.azurewebsites.net/api/Meetings/this_month",
        headers: {
          "Content-Type": "application/json",
          "Authorization": "bearer " + token
        },
  ...
  Future _getLastMonth() async {
    SharedPreferences.getInstance().then((value) {
      ...
      http.get(
        "https://mobibookingwebapi.azurewebsites.net/api/Meetings/last_month",
        headers: {
          "Content-Type": "application/json",
          "Authorization": "bearer " + token
        },
